...
from app._vendor.deepagents.backends.protocol import ExecuteResponse, SandboxBackendProtocol
...
class LocalShellBackend(FilesystemBackend, SandboxBackendProtocol):
    ...
    Examples:
        ```python
        from app._vendor.deepagents.backends import LocalShellBackend
    ...
    def __init__(
        ...
        *,
        ...
        # --- SECMANUS PATCH: fmt_timestamp DI pass-through (start) ---
        fmt_timestamp: Callable[[float], str] | None = None,
        # --- end SECMANUS PATCH (fmt_timestamp DI pass-through) ---
    ) -> None:
