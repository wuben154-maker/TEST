...
from app._vendor.deepagents.backends import FilesystemBackend
...
from app._vendor.deepagents.backends import CompositeBackend
...
if TYPE_CHECKING:
    ...
    from app._vendor.deepagents.backends.protocol import BACKEND_TYPES, BackendProtocol
...
class _DeepAgentsSummarizationMiddleware(AgentMiddleware):
    ...
    def __init__(
        ...
        **deprecated_kwargs: Any,
        ...
        Example:
            ```python
            from app._vendor.deepagents.middleware.summarization import SummarizationMiddleware
