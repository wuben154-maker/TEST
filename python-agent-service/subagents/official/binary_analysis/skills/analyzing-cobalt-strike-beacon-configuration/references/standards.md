...
Field IDs and XOR notes below are **domain reference** for FR-13 reasoning.
Persisting findings uses **`evidence_chain.append_indicator`** with Proto-02
buckets (`strings_iocs`, `llm_inferences`, …); do not treat this markdown as a
