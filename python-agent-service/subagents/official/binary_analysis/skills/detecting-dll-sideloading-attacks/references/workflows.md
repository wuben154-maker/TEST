...
> **Scope:** **Human** blue-team / SOC playbooks (Splunk / MDE KQL). These are
> **not** steps for the `binary_analysis` runtime agent; the agent follows
> `detecting-dll-sideloading-attacks/SKILL.md` and project contracts for FR-17
> in-sandbox work.
