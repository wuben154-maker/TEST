...
Rules in this repository are drafted for **sandbox execution** and report
appendices. Do not treat the metrics below as permission to score live host
paths or to bypass `binary-analysis-sanitize-untrusted-strings` (Proto-03).
